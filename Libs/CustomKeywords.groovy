...
def static "website.UsersPage.clickAddButton"() {
    (new website.UsersPage()).clickAddButton()
}

def static "website.UsersPage.clickEditUser"(
    	String user	) {
    (new website.UsersPage()).clickEditUser(
        	user)
}

def static "website.UsersPage.verifyNewUserAdded"(
    	String username	) {
    (new website.UsersPage()).verifyNewUserAdded(
        	username)
}

def static "website.UsersPage.verifyNewStatus"(
    	String username	
     , 	String newStatus	) {
    (new website.UsersPage()).verifyNewStatus(
        	username
         , 	newStatus)
}

def static "website.TestCaller.login"(
    	String email	
     , 	String password	) {
    (new website.TestCaller()).login(
        	email
         , 	password)
}

def static "website.DashboardPage.verifySuccessfulLogin"() {
    (new website.DashboardPage()).verifySuccessfulLogin()
}

def static "website.SignInPage.login"(
    	String email	
     , 	String password	) {
    (new website.SignInPage()).login(
        	email
         , 	password)
}

def static "website.SignInPage.enterEmail"(
    	String email	) {
    (new website.SignInPage()).enterEmail(
        	email)
}

def static "website.SignInPage.enterPassword"(
    	String password	) {
    (new website.SignInPage()).enterPassword(
        	password)
}

def static "website.SignInPage.clickSingIn"() {
    (new website.SignInPage()).clickSingIn()
}

def static "website.SignInPage.clickCreateAccount"() {
    (new website.SignInPage()).clickCreateAccount()
}

def static "website.Helper.startApp"() {
    (new website.Helper()).startApp()
}

def static "website.Helper.closeBrowser"() {
    (new website.Helper()).closeBrowser()
}

def static "website.UserInfoPage.enterData"(
    	String employee	
     , 	String username	
     , 	String role	
     , 	String supervisor	
    ...
    (new website.UserInfoPage()).enterData(
        	employee
         , 	username
         , 	role
         , 	supervisor
...
def static "website.UserInfoPage.selectOption"(
    	TestObject object	
     , 	String option	) {
    (new website.UserInfoPage()).selectOption(
        	object
         , 	option)
}

def static "website.UserInfoPage.editStatus"(
    	String newStatus	) {
    (new website.UserInfoPage()).editStatus(
        	newStatus)
}

def static "website.SidePanel.selectOptionUsers"() {
    (new website.SidePanel()).selectOptionUsers()
}
