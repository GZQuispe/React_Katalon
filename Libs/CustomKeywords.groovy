...
def static "website.AddUserPage.enterData"(
    	String employee	
     , 	String username	
     , 	String role	
     , 	String supervisor	
    ...
    (new website.AddUserPage()).enterData(
        	employee
         , 	username
         , 	role
         , 	supervisor
...
def static "website.AddUserPage.selectOption"(
    	TestObject object	
     , 	String option	) {
    (new website.AddUserPage()).selectOption(
        	object
         , 	option)
}
